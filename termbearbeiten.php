...
<label for="beginn">Beginn: </label><input type="text" id="beginn" name="beginn" value=""/><br />
<label for="ende">Ende: </label><input type="text" id="ende" name="ende" value=""/><br />
<label for="dauer">Dauer: </label><input type="text" id="dauer" name="dauer" value=""/><br />
